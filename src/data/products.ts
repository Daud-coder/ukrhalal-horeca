  ...
  sausages: [
    {
      ...
      items: [
        ...
        { name: 'Грудинка теляча копчена (крафт)', price: 500 },
        { name: 'Ребро копчене (крафт)', price: 410 },
        { name: 'Балик теляч. копчений (крафт)', price: 1045 },
        { name: 'Джерки яловичі (ворчестер)', price: 1650 },
        { name: 'Джерки курячі', price: 1650 },
        { name: 'Крило куряче копчене (УкрХаляль)', price: 290 },
        { name: 'Гомілка копчена (УкрХаляль)', price: 320 },
        { name: 'Філе Янтарне с/к (УкрХаляль)', price: 650 },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'ВІ Курхан', price: 800 },
        { name: 'ВІ Салямі яловича с/к', price: 800 },
        { name: 'ВІ Кримські', price: 305 },
        { name: 'ВІ Болгарська', price: 375 },
      ],
    },
    {
      label: 'Ковбаски',
      items: [
        { name: 'Мюнхенські ковбаски (УкрХаляль)', price: 400 },
        { name: 'Мюнхенські ковбаски з сиром (УкрХаляль)', price: 410 },
        { name: 'Мисливські ковбаски', price: 300 },
        { name: 'Баварські ковбаски', price: 310 },
        { name: 'Баварські ковбаски з сиром', price: 330 },
      ],
    },
    {
      label: 'Сосиски та сардельки',
      items: [
        { name: 'Сосиски молочні', price: 275 },
        { name: 'Сосиски з сиром', price: 345 },
        { name: 'Сосиски Дитячі в/с (УкрХаляль)', price: 342 },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Голандська з сиром', price: 540 },
        { name: 'Татарська в/с', price: 520 },
        { name: 'Ковбаса Харківська с/к', price: 730 },
      ],
    },
    {
      label: 'Нові позиції',
      items: [
        ...
        { name: 'Сервелат Баварський', price: 420 },
        { name: 'Сардельки телячі', price: 360 },
      ],
    },
  ],
  semi: [
    {
      label: 'Пельмені',
      items: [
        { name: 'Пельмені курячі (900 г)', price: 255, unit: 'уп.' },
        { name: 'Пельмені яловичі (900 г)', price: 260, unit: 'уп.' },
        { name: 'Пельмені з баранини (900 г)', price: 280, unit: 'уп.' },
        { name: "Пельмені Мікс (ялов.+курка) 900 г", price: 260, unit: 'уп.' },
        { name: 'Пельмені з індички 500 г', price: 193, unit: 'уп.' },
        ...
        { name: 'Пельмені Малюкам (400 г)', price: 190, unit: 'уп.' },
      ],
    },
    {
      label: 'Самса',
      items: [
        { name: 'Самса курка', price: 295, unit: 'шт.' },
        { name: 'Самса яловича', price: 310, unit: 'шт.' },
        { name: 'Самса з бараниною', price: 330, unit: 'шт.' },
        { name: 'Міні самса з куркою 500 г', price: 175, unit: 'уп.' },
        { name: 'Міні самса з телятиною 500 г', price: 180, unit: 'уп.' },
        { name: 'Міні самса з бараниною 500 г', price: 190, unit: 'уп.' },
      ],
    },
    {
      label: 'Страви та вироби',
      items: [
        { name: 'Хінкалі', price: 275 },
        { name: 'Манти з телятиною', price: 275, unit: 'уп.' },
        { name: 'Долма', price: 380, unit: 'уп.' },
        { name: 'Голубці з яловичиною', price: 310, unit: 'уп.' },
        { name: 'Чебуреки яловичі 400 г', price: 160, unit: 'уп.' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Тефтельки Дитячі (400 г)', price: 185, unit: 'уп.' },
        { name: 'Сирники ванільні (400 г)', price: 175, unit: 'уп.' },
        { name: 'Млинці з куркою', price: 170, unit: 'уп.' },
        { name: 'Міні млинці з сиром 600 г', price: 325, unit: 'уп.' },
      ],
    },
    {
      label: 'Бургери',
      items: [
        { name: 'Бургер курячий', price: 230 },
        { name: 'Бургер яловичина охолоджений', price: 255 },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Тушонка з баранини в/с ДСТУ', price: 180, unit: 'уп.' },
        { name: 'Тушонка з курятини ж/б 525 г', price: 140, unit: 'уп.' },
      ],
    },
  ],
};
